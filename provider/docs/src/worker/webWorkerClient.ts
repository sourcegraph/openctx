...
import type { WorkerEmbedTextMessage, WorkerMessagePair } from './api.ts'

export const embedTextOnWorker: typeof embedTextInThisScope = async (
    text: string
): Promise<Float32Array> => sendMessage<WorkerEmbedTextMessage>('embedText', text)
