...
OpenCodeGraph **providers** are simple programs that fetch relevant information about a code file from other dev tools:
...
This information is consumed by OpenCodeGraph **clients**:
