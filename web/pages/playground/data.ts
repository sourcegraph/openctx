...
const settings = {
    'openctx.providers': {
        [providerBundleUrl('@openctx/provider-links@0.0.9', providerLinksUrl)]: {
            links: [
                {
                    title: 'Telemetry',
        ...
        [providerBundleUrl('@openctx/provider-prometheus@0.0.7', providerPrometheusUrl)]: {
        ...
        [providerBundleUrl('@openctx/provider-storybook@0.0.7', providerStorybookUrl)]: {
            storybookUrl:
