...
const settings = {
    'openctx.providers': {
        [providerBundleUrl('@openctx/provider-links@0.0.8', providerLinksUrl)]: {
            links: [
                {
                    title: 'Telemetry',
        ...
        [providerBundleUrl('@openctx/provider-prometheus@0.0.6', providerPrometheusUrl)]: {
        ...
        [providerBundleUrl('@openctx/provider-storybook@0.0.6', providerStorybookUrl)]: {
            storybookUrl:
